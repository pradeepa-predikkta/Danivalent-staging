...
<head>
	...
	<meta name="p:domain_verify" content="0fff3c2977eb4ba182d809c7c67fd0f7"/>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-ND7ZFKT"
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<!-- End Google Tag Manager (noscript) -->
	<div class="u_type" id="<? echo $usr; ?>" style="display:none;"></div>
	...
	<div id="wrapper" class="<?php echo esc_attr( $wrapper_class ); ?>">
		...
		<div id="sliders-container">
		     <?php
				// UB Custom Widget
				 if (is_page(256)) {
				 dynamic_sidebar('hm-smartslider-position');
					}
			 ?>
			<?php
			if ( is_search() ) {
		...
		?>
		<?php if ( $slider_fallback && 'flex' !== $slider_fallback ) : ?>
