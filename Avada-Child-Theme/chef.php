...
<?php get_header(); ?>
    ...
    <div id="media-posts-container" class="clearfix">
        <div class="media-listing-container media-intro">
            ...
            <?php if ($registered || $paid || $user_role == "subscriber" || $user_role == "customer") { ?>
                <div class="category-dropdown-container">
                	<div class="item-search">
						<input type="text" class="search-query" placeholder="Search Chefs" />
                    </div>
                        ...
                        <div class="category-dropdown-list">
                            ...
                            <?php foreach($categories as $category) { ?>
                            	<?php if($category->count > 0) { ?>
                                	<li><a href="<?php site_url() ?>/media/chefs/<?php echo $category->slug; ?>" data-selected="<?php echo $category->name; ?>"><?php echo $category->name; ?></a></li>
								<?php } ?>
                            <?php } ?>
                                <li class="blank"><a href="<?php site_url() ?>/chefs/">All Chefs</a></li>
                            </ul>
                        </div>
                    </div>
		...
		<div class="media-listing-container media-content">    
        	<?php if ($user_role == "subscriber" || $user_role == "customer") { 
				$args = array( 'post_type' => 'media', 'media_categories' => 'chefs', 'orderby' => 'published', 'order' => 'ASC', 'posts_per_page' => -1 );
                ...
                <?
					...
					$f_args = array( 'post_type' => 'media', 'media_categories' => 'chefs', 'posts_per_page' => -1);
					...
					if ($fcount == 0) {		
						$offset = 1;				
						$l_args = array( 'post_type' => 'media', 'media_categories' => 'chefs', 'posts_per_page' => 1);
                ...
                <ul class="grid-3 media-list">
                    <?php
						$args = array( 'post_type' => 'media', 'media_categories' => 'chefs', 'posts_per_page' => 9, 'offset' => $offset );
                    	$loop = new WP_Query( $args );
                ...
                <div class="load-more-container">
                	<?
                    	$fp_args = array( 'post_type' => 'media', 'media_categories' => 'chefs', 'posts_per_page' => -1);
                	...
                	<?php if ($notsneakcount > 9) { ?>
                		<a href="#" class="btn load-more" data-level="0" data-type="chefs">Load more - Total <?php echo $notsneakcount; ?> Chefs</a>
                    <?php } ?>
                </div>
            <?php } else { ?>
            	<a class="teaser" href="<?php echo site_url() ?>/my-account/">
                	<img class="desktop" src="<?php echo site_url() ?>/wp-content/uploads/2015/08/teaser-chef.jpg">
                    <img class="mobile" src="<?php echo get_stylesheet_directory_uri() ?>/images/mobile_preview_chef.jpg">
                </a>
			<?php } ?>
		</div>
    </div>
